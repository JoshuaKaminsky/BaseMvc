...
namespace BaseMvc.Data.Bolts
{
    internal class EFRepository<T> : IRepository<T> where T : BaseEntity
    {
        ...
        public T Get(Expression<Func<T, bool>> filter, List<string> includes = null)
        {
        ...
        private IQueryable<T> GetItems(Expression<Func<T, bool>> filter, List<string> includes = null)
        {
